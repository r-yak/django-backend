...
class Drug(models.Model):
    ...
    CLASS_NO = models.IntegerField(verbose_name="분류번호", max_length=5)
    ETC_OTC_CODE = models.IntegerField(verbose_name="전문/일반", max_length=2)
    ITEM_PERMIT_DATE = models.DateField (verbose_name="품목허가일자")
    SHAPE_CODE = models.IntegerField(verbose_name="제형코드", max_length=6)
